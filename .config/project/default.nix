...
### https://sellout.github.io/project-manager/options.xhtml
{
    ...
    file = let
      ...
      perPackageFiles = dir: {
        ...
        "${dir}/henforcer.toml".text =
          ...
          + ''
            ## Exclude autogenerated ‘Paths’ module
            [[forPatternModules]]
            pattern = "Paths_*"
            [forPatternModules.rulesToIgnore]
            all = true

            ## Exclude autogenerated ’Build_doctests’ module
            [[forSpecifiedModules]]
  ...
  programs.vale.vocab.${config.project.name}.accept = [
    ...
    "preprocessor"
    "Stackage"
    ## TODO: These are added for "henforcer.toml". When `perPackageFiles` moves
    ##       upstream, move this as well.
    "autogenerated"
    "Build_doctests"
  ];
