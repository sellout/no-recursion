...
import safe "recursion-analysis" GHC.Recursion.Core (failOnRecursion)
import safe "recursion-analysis" GHC.Recursion.Options
...
import safe "recursion-analysis" GHC.Recursion.Record (formatRecursionRecord)
